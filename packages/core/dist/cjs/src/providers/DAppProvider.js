...
function DAppProviderWithConfig(_a) {
    ...
    return (jsx_runtime_1.jsx(EthersProvider_1.EthersProvider, { children: jsx_runtime_1.jsxs(provider_2.BlockNumberProvider, { children: [jsx_runtime_1.jsx(NetworkActivator_1.NetworkActivator, {}, void 0),
                jsx_runtime_1.jsx(chainState_1.ChainStateProvider, __assign({ multicallAddresses: multicallAddressesMerged }, { children: jsx_runtime_1.jsx(provider_3.NotificationsProvider, { children: jsx_runtime_1.jsx(provider_4.TransactionProvider, { children: children }, void 0) }, void 0) }), void 0)] }, void 0) }, void 0));
}
